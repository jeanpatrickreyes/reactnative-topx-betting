...
const styles = StyleSheet.create({
    ...
    headerRightGroup: { flex: 1, flexDirection: 'row', alignItems: 'center', paddingLeft: 11, gap: 8, minWidth: 0 },
    headerValueTextAlign: { flex: 1, flexShrink: 1, minWidth: 0, paddingLeft: 0, marginRight: 0 },
    headerRightSpacer: { flex: 1, minWidth: 0 },
